...
void check_alkyl(short pos[100][4], short& len, short poi[1][2], short key);
void check_t(short pos[100][4], short& len, short poi[1][2]);
void check_y(short pos[100][4], short& len, short poi[1][2]);
void check_halogen(short pos[100][4], short& len, short poi[1][2], short key);
void check_k(short pos[100][4], short& len, short poi[1][2]);